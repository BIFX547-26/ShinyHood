...
An example Shiny app illustrating various deployment methods. Ths Shiny app displays information about the Hood College bioinformatics program courses, which is neither complete nor up to date.
...
-   Create a free account at [shinyapps.io](https://www.shinyapps.io) if you don't have one.
...
-   Open the Posit Publisher pane in [Positron](https://positron.posit.co/) by clicking on the {{< iconify bi arrow-up-circle >}} icon on the left.
...
-   Open `app.R` and look for the Posit Publisher icon ({{< iconify bi arrow-up-circle >}}) near the top right of the file window.
    ...
    -   My deployment can be viewed [here](https://connect.posit.cloud/randyjohnson/content/019c967a-5c55-1508-bb00-ed842bdff629?utm_source=publisher-positron)
